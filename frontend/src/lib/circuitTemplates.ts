    ...
    nodes: [
      {
        ...
        type: "gateNode",
        position: { x: 80, y: 160 },
        data: { type: "INPUT", label: "aTc" },
      },
      {
        id: "t2",
        type: "gateNode",
        position: { x: 80, y: 280 },
        data: { type: "INPUT", label: "AraC" },
      },
      {
        id: "t3",
        type: "gateNode",
        position: { x: 300, y: 220 },
        data: { type: "AND", label: "AND gate" },
      },
      {
        id: "t4",
        type: "gateNode",
        position: { x: 520, y: 220 },
        data: { type: "OUTPUT", label: "GFP" },
      },
    ],
    edges: [
      {
    ...
    nodes: [
      {
        ...
        type: "gateNode",
        position: { x: 80, y: 160 },
        data: { type: "INPUT", label: "A" },
      },
      {
        id: "to2",
        type: "gateNode",
        position: { x: 80, y: 280 },
        data: { type: "INPUT", label: "B" },
      },
      {
        id: "to3",
        type: "gateNode",
        position: { x: 300, y: 220 },
        data: { type: "OR", label: "OR gate" },
      },
      {
        id: "to4",
        type: "gateNode",
